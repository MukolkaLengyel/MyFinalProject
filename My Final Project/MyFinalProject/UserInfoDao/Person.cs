...
public sealed record Person : EntityWithId
{
    ...
    public Person(string returnUrl) => ReturnUrl = returnUrl;
    ...
    public Person(string firstName, string lastName, int age, string gender, string username, string password,
        string role)
    {
        FirstName = firstName;
        LastName = lastName;
